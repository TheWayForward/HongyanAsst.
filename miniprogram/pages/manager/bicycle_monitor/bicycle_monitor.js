...
Page({
          ...
          success: function (res) {
            ...
            if (x == batchTimes) {
              ...
              for (var k = 0; k < arrayContainer.length; k++) {
                ...
                bicycles_normal.push(arrayContainer[k]);
              }
              ...
              that.setData({
                ...
                bicycles_normal: bicycles_normal.sort(compare_helper.compare("time_created")).reverse(),
  ...
  show_bicycles_normal: function (e) {
    var that = this;
    that.setData({
      is_bicycles_normal_hide: !that.data.is_bicycles_normal_hide
    })
  },
  ...
  goto_bicycle_detail_check: function (e) {
    ...
    wx.navigateTo({
      url: '../bicycle_monitor/bicycle_detail_check/bicycle_detail_check',
    })
  }
