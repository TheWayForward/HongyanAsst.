...
function bicycle_password_verification(bicycle_password) {
  return bicycle_password.length >= 6 && bicycle_password.length <= 20 ? true : false;
}
...
module.exports = {
  ...
  bicycle_password_verification: bicycle_password_verification,
